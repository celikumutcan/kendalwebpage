  ...
  KSL1903: {
    ...
    attributes: {
      tr: [
        ...
        {
          label: 'Işık Rengi',
          value: 'CCT (Günışığı (3000K), Ararenk (4000K), Beyaz (6500K))',
        },
      ...
      en: [
        ...
        { label: 'Lumen', value: '3600' },
        {
          label: 'Light Color',
          value:
            'CCT (Warm White (3000K), Natural White (4000K), Cool White (6500K))',
        },
    ...
    category: {
      tr: ['Armatür', 'Linear Armatür'],
      en: ['Armatür', 'Linear Fixture'],
    },
    brand: 'k2',
