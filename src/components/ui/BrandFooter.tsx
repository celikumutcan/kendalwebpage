      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          ...
          <div className="flex gap-4">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/kendal-elektrik-ayd%C4%B1nlatma-a-%C5%9F/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-[var(--brand-red)] transition-colors" aria-label="LinkedIn">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/k2.ledsystem/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-[var(--brand-red)] transition-colors" aria-label="Instagram">
