      ...
      <div className="max-w-[90rem] mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col items-center text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-extrabold mb-4 md:mb-6 tracking-tight leading-tight">
            ...
            {(t as any).company_stats?.title_part3 || 'Gururu'}
          </h2>
        ...
        <div className="photo-card relative w-full max-w-5xl mx-auto aspect-[16/9] lg:aspect-[24/9] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 mb-10 lg:mb-16 group">
          ...
          <div className="absolute bottom-6 left-6 md:bottom-10 md:left-12 flex flex-col">
            <span className="text-white font-bold text-2xl md:text-4xl tracking-tight drop-shadow-lg mb-2">
              Kendal Elektrik
            </span>
            <span className="text-white/80 font-medium text-sm md:text-lg tracking-wide flex items-center gap-2">
              <svg
                className="w-5 h-5 text-[var(--brand-red)]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
