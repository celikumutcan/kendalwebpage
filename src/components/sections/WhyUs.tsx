...
export const WhyUs = () => {
  ...
  const features = [
    {
      title: t.why_us.item1_title,
      desc: t.why_us.item1_desc,
      icon: <IconBox />,
    },
    {
      title: t.why_us.item2_title,
      desc: t.why_us.item2_desc,
      icon: <IconShield />,
    },
    {
      title: t.why_us.item3_title,
      desc: t.why_us.item3_desc,
      icon: <IconStar />,
    },
    {
      title: t.why_us.item4_title,
      desc: t.why_us.item4_desc,
      icon: <IconNetwork />,
    },
    {
      title: (t as any).why_us.item5_title,
      desc: (t as any).why_us.item5_desc,
      icon: <IconCheckBadge />,
    },
  ];
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% -10%, #ffb347 0%, transparent 60%)',
        }}
      />
      <div
        className="absolute bottom-0 right-0 w-full h-[500px] pointer-events-none opacity-10 mix-blend-screen"
        style={{
          background:
            'radial-gradient(circle at 100% 100%, #ffb347 0%, transparent 60%)',
        }}
      />
