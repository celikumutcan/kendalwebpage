...
export const Hero = () => {
  ...
  return (
    ...
    >
      <div className="md:sticky md:top-0 h-screen w-full overflow-hidden flex flex-col items-center justify-start pt-10 md:justify-center md:pt-24 [@media(max-height:820px)]:pt-14">
        ...
        >
          <div className="mb-6 md:mb-4 inline-block rounded-full border border-white/25 bg-black/25 px-5 py-2 text-base md:text-lg font-semibold tracking-widest backdrop-blur-sm shadow-[0_0_15px_rgba(0,0,0,0.25)] [filter:drop-shadow(0_1px_4px_rgba(0,0,0,0.5))] [@media(max-height:820px)]:mb-3">
            {t.hero.badge}
          </div>
          ...
          <p className="mt-10 md:mt-6 max-w-lg text-xl sm:text-2xl md:text-xl text-white font-medium [filter:drop-shadow(0_0_6px_rgba(0,0,0,0.5))_drop-shadow(0_2px_6px_rgba(0,0,0,0.7))] [@media(max-height:820px)]:mt-5 [@media(max-height:820px)]:text-xl">
            {t.hero.subtitle}
          </p>
          <div className="mt-10 md:mt-8 relative w-72 h-32 md:w-[32rem] md:h-44 transition-transform hover:scale-105 duration-500 [@media(max-height:820px)]:mt-6 [@media(max-height:820px)]:h-24 [@media(max-height:820px)]:md:h-28">
            <Image
