  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white pt-32 pb-24 px-6 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute -left-[20%] top-1/2 -translate-y-1/2 w-[700px] h-[950px] bg-purple-600/40 blur-[160px] rounded-[100%]" />
        <div className="absolute -right-[20%] top-1/2 -translate-y-1/2 w-[700px] h-[950px] bg-fuchsia-500/40 blur-[160px] rounded-[100%]" />
      </div>
